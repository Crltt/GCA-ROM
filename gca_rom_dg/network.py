...
class Net(torch.nn.Module):
    ...
    def __init__(self, HyperParams):
        super().__init__()
        self.encoder = gca.Encoder(HyperParams.hidden_channels, HyperParams.bottleneck_dim, [HyperParams.nodes,3], ffn=HyperParams.ffn, skip=HyperParams.skip)
        self.decoder = gca.Decoder(HyperParams.hidden_channels, HyperParams.bottleneck_dim,[HyperParams.nodes,3], ffn=HyperParams.ffn, skip=HyperParams.skip)
